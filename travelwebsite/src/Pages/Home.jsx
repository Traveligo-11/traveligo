...
const Home = () => {
  ...
  const holidayPackages = [
    ...
    },
    {
      ...
      destination: "7D/6N in Singapore & Malaysia",
      duration: "7 Days",
      price: "₹67,999",
      originalPrice: "₹89,999",
      discount: "25%",
      ...
      itinerary: [
        { day: 1, title: "Arrival in Singapore", description: "Airport transfer. Evening at Clarke Quay." },
        { day: 2, title: "Singapore City Tour", description: "Merlion Park, Gardens by the Bay, and Sentosa Island." },
        { day: 3, title: "Universal Studios", description: "Full day at Universal Studios Singapore." },
        { day: 4, title: "Travel to Kuala Lumpur", description: "Visit Batu Caves and Petronas Twin Towers." },
        { day: 5, title: "Genting Highlands", description: "Cable car ride and leisure time at resort." },
        { day: 6, title: "Return to Singapore", description: "Free time for shopping on Orchard Road." },
        { day: 7, title: "Departure", description: "Transfer to Singapore airport." }
      ],
      inclusions: [
        "6 nights accommodation (4* hotels)",
        "Daily breakfast",
    ...
    },
    {
      ...
      destination: "10D/9N in Australia",
      duration: "10 Days",
      price: "₹1,89,999",
      ...
      itinerary: [
        { day: 1, title: "Arrival in Sydney", description: "Airport transfer. Evening Harbour Cruise." },
        { day: 2, title: "Sydney Sightseeing", description: "Opera House, Harbour Bridge, and Bondi Beach." },
        { day: 3, title: "Blue Mountains", description: "Scenic World rides and wildlife park visit." },
        { day: 4, title: "Fly to Cairns", description: "Free time at leisure to explore Cairns." },
        { day: 5, title: "Great Barrier Reef", description: "Full day reef tour with snorkeling." },
        { day: 6, title: "Fly to Gold Coast", description: "Visit Surfers Paradise beach." },
        { day: 7, title: "Theme Park Day", description: "Choose between Movie World or Sea World." },
        { day: 8, title: "Fly to Melbourne", description: "City tour including Federation Square." },
        { day: 9, title: "Phillip Island", description: "Penguin Parade evening tour." },
        { day: 10, title: "Departure", description: "Transfer to Melbourne airport." }
      ],
      inclusions: [
